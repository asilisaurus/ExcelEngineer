...
// Тестирование обработки Google Sheets с надежным процессором
async function testGoogleSheetsProcessing() {
  try {
    console.log('🧪 Тестирование обработки Google Sheets...');
